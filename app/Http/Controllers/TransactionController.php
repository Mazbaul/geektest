...
class TransactionController extends Controller
{
    ...
    public function sendMoney(SendMoneyRequest $request): TransactionResource|JsonResponse
    {
        ...
        $sender = $this->userRepository->getUserById($request->sender_id);
    ...
    public function userTransactionInfo(Request $request): JsonResponse
    {
        ...
        if($user_id>0) {
            ...
            $thirdHighestTransaction=$this->transactionRepository->getThirdHighestTransactionByUserId($user_id);
            $data['thirdHighestTransaction'] = !empty($thirdHighestTransaction) ? $thirdHighestTransaction[0]->transactionAmount : 0;
        }
